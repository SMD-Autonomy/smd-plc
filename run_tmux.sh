...
then
    ...
    tmux send-keys -t $SESSION:0.1 'cd ros2_publisher; ros2 run plc_publisher plc_publisher --ros-args -p camera_id:=10 -p lamp_intensity:=90.0 -p panandtilt_x:=100.0 ' C-m  
